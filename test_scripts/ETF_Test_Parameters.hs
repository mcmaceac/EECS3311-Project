...
-- Should the regression testing proceeds with a list of expected files, or the oracle?
...
--   expected output files are copied from the directory containing 'acceptance_tests' into 'log_dir'
